...
class OrderReturnPolicy extends MY_Controller 
{
			...
			{                   
				...
				if($this->form_validation->run())
				{
					...
					$post['page_updated_date'] = date('Y-m-d');
                   	...
                   	$msg = 'Order Return Policy updated successfully!!';					
					...
					redirect(base_url().MODULE_NAME.'orderReturnPolicy');
				}
				else
				{
					...
					{
						$this->show_view(MODULE_NAME.'orderReturnPolicy/orderReturnPolicy_view', $this->data);
					}	
					else
					{
						redirect(base_url().MODULE_NAME.'orderReturnPolicy');
