				  	...
				  	<div class="form-area">  
				        <form action="<?php echo base_url(); ?>login/resetPassword" method="post" id="login_form" accept-charset="utf-8">
							...
							<div class="form-group">
								<input required type="email" name="user_email" id="user_email" placeholder="email" class="form-control">
                            	<?php echo form_error('user_email','<span class="text-danger">','</span>'); ?>
							</div>
					        <button type="submit" name="forgot_password" id="forgot_password" value="forgot_password" class="btn btn-primary pull-right">Send Mail</button>
				        </form>
				    </div>
			  	</div>
			</div>
