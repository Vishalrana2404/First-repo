	...
	<div class="container" style="text-align: center;">
		<div class="contact_box">
			...
			<div id="login" class="tab-pane fade in active">
			  	<div class="form_area">
				  	<div class="form-area">  
				        <form action="<?php echo base_url(); ?>login/resetPassword" method="post" id="login_form" accept-charset="utf-8">
							...
							<div class="form-group">
								<input required type="password" name="user_cpassword" id="user_cpassword" placeholder="Confirm Password" class="form-control">
                            	<?php echo form_error('user_cpassword','<span class="text-danger">','</span>'); ?>
							</div>
					        <button type="submit" name="reset_password" id="reset_password" value="reset_password" class="btn btn-primary pull-right">Reset Password</button>
				        </form>
				    </div>
			  	</div>
			</div>
