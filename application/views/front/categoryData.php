         ...
         <ul class="page-title-link">
            <?php 
               if(empty($category_id)){
                  ...
                  <li><a href="#"><span><?php echo $myobj->loadPo('Category'); ?></span></a></li>
                  <?php
               }
               else{
                  $category_detail = $this->common_model->getData('tbl_category', array('category_id'=>$category_id), 'single'); 
                  ?>
                  <li><a href="<?php echo base_url(); ?>"><?php echo $myobj->loadPo('Home'); ?></a></li>
                  <li><a href="<?php echo base_url(); ?>category"><span class="color"><?php echo $myobj->loadPo('Category'); ?></span></a></li>
                  <?php
                  if(!empty($category_detail)){
                     ?>
                        <li><a href="#"><span><?php echo ($lng == 'ara') ? $category_detail->category_name_ar : $category_detail->category_name; ?></span></a></li>
                     <?php
                  }
               }
            ?>
