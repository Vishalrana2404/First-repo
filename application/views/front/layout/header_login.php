...
<html lang="<?php if($lng == 'eng'){ echo 'en'; } else{ echo 'ar'; } ?>" dir="<?php if($lng == 'eng'){ } else{ echo 'rtl'; } ?>">
   <head>
      ...
      <link href="//db.onlinewebfonts.com/c/80ef43d3685d74fc0e7ba8490cd6adc1?family=Avenir+LT+Pro" rel="stylesheet" type="text/css"/>
   </head>
   <body>
      <div class="top-bar">
         <div class="container">
                  ...
                  <div class="right-top">
                     <div class="social-box listcolor headRightIco">
                        <ul>
                           <li class="dropdown cartBox">
                              <?php
                                 if($user_id){
                                    ...
                                    if(!empty($wish_list)){
                                       ?>
                                       <a href="#" class="" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><!-- <i class="fa fa-heart-o view-modal" aria-hidden="true"></i> --><img src="<?php echo base_url(); ?>webroot/front/images/heart.png" alt="img"><span class="cartNum"><?php echo count($wish_list); ?></span></a>
                           ...
                           <li class="dropdown">
                              <a href="#" class="" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url(); ?>webroot/front/images/profile.png" alt="img"></a>
                              <ul class="dropdown-menu setting">
                                 <li class="drpHead"><a href="#!"><?php echo $user_name; ?> <i class="fa fa-times" aria-hidden="true"></i></a></li>
                                 <li><a href="<?php echo base_url(); ?>profile"><?php echo $myobj->loadPo('Profile'); ?></a></li>
                                 <li><a href="#"><?php echo $myobj->loadPo('My Order'); ?></a></li>
                                 <li><a href="<?php echo base_url(); ?>home/logout"><?php echo $myobj->loadPo('Logout'); ?></a></li>
                              </ul>
                           </li>
                           
                           <li class="dropdown cartBox">
                              <a href="#" class="" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><!-- <i class="fa fa-shopping-cart view-modal" aria-hidden="true"></i> --><img src="<?php echo base_url(); ?>webroot/front/images/bag.png" alt="img"><span class="cartNum"><?php echo $this->cart->total_items(); ?></span></a>
         ...
         <nav class="megamenu navbar navbar-default">
            <div class="container">
               <div class="navbar-header">
                  <div class="dropdown">
                     <a class="dropdown-toggle categoryDrop" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span>
                      &nbsp;&nbsp;<?php echo $myobj->loadPo('All Categories'); ?> &nbsp;&nbsp; <i class="fa fa-bars" aria-hidden="true"></i></span>
                     </a>
                  ...
                  <span class="sr-only"><?php echo $myobj->loadPo('Toggle navigation'); ?></span>
               ...
               <div id="navbar" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="category_main_drop"><a class="<?php if($uri_segment == 'category'){ echo 'active'; } ?>" href="<?php echo base_url(); ?>category"><?php echo $myobj->loadPo('Category'); ?><i class="fa fa-caret-down desktop_view_icon"></i><i class="fas fa-chevron-left mobile_vew_icon"></i></a>
                                ...
                                if(!empty($category_res)){
                                    foreach($category_res as $c_val) {
                                        ...
                                        if(!empty($sub_category_res)){
                                            ?>
                                            <li class="cat_drop"><a href="<?php echo base_url(); ?>category/<?php echo $c_val->category_id; ?>"><?php echo ($lng == 'ara') ? $c_val->category_name_ar : $c_val->category_name; ?></a><i class="fas fa-chevron-left"></i>
                     ...
                     <!-- <li><a class="<?php if($uri_segment == ''){ echo 'active'; } ?>" href="#"><?php echo $myobj->loadPo('Free Shipping on order S50+'); ?></a></li> -->
                  </ul>
                                            ...
                                            <?php
                                                foreach($sub_category_res as $s_val) {
                                                    $subS_category_res = $this->common_model->getData('tbl_category', array('category_status'=>'1', 'parent_category_id'=>$s_val->category_id), 'multi');
                                                                            if(!empty($subS_category_res)){
                                                                                ?>
                                                                                <li class="cat_drop"><a href="<?php echo base_url(); ?>category/<?php echo $s_val->category_id; ?>"><?php echo ($lng == 'ara') ? $s_val->category_name_ar : $s_val->category_name; ?></a>
                                                                                    <ul class="drop_second_in">
                                                                                        <?php
                                                                                            foreach($subS_category_res as $sS_val) {
                                                                                                ?>
      ...
      <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
            ...
            <li><a class="<?php if($uri_segment == 'about'){ echo 'active'; } ?>" href="<?php echo base_url(); ?>about"><?php echo $myobj->loadPo('About'); ?></a></li>
            <li><a class="<?php if($uri_segment == 'contact'){ echo 'active'; } ?>" href="<?php echo base_url(); ?>contact"><?php echo $myobj->loadPo('Contact'); ?></a></li>
            <li><a class="" ><?php echo $myobj->loadPo('Helps'); ?><i class="fa fa-caret-down desktop_view_icon"></i></a>
                                <ul>
