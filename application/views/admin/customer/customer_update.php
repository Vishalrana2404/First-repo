<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo base_url().MODULE_NAME;?>cutomers"><?php echo $myobj->loadPo('About'); ?>Cutomer</a></li>
         <li class="active"><?php echo $myobj->loadPo('Update Customer'); ?></li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('Update Customer'); ?> </h3>
            </div>
            <div class="pull-right box-tools">
               <a href="<?php echo base_url().MODULE_NAME;?>cutomer" class="btn btn-info btn-sm"><?php echo $myobj->loadPo('About'); ?>Back</a>
            </div>
         </div>
         <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="cutomer_name" id="cutomer_name" class="form-control" type="text" value="<?php echo $edit_cutomer->cutomer_name; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="cutomer_email" id="cutomer_email" class="form-control" type="email" value="<?php echo $edit_cutomer->cutomer_email; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="cutomer_phone_no" id="cutomer_phone_no" class="form-control" type="text" value="<?php echo $edit_cutomer->cutomer_phone_no; ?>" />
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <select data-validation="required" name="cutomer_status" id="cutomer_status" class="form-control">
                           <option <?php echo ($edit_cutomer->cutomer_status == 1) ? 'selected' : ''; ?> value="1">Active</option>
                           <option <?php echo ($edit_cutomer->cutomer_status == 0) ? 'selected' : ''; ?> value="0">Inactive</option>
                        </select>
                  ...
                  <div class="form-group col-md-4">
                        <div class="input text">
                            ...
                            <?php
                                if(!empty($edit_cutomer->cutomer_img))
                                {
                                    ?>
                                    <img width="100px" src="<?php echo base_url().''.$edit_cutomer->cutomer_img; ?>">
                                    <?php
                                }
                                else
                                {
               ...
               <div class="box-footer">
                  ...
                  <a class="btn btn-danger btn-sm" href="<?= base_url().MODULE_NAME;?>cutomer"><?php echo $myobj->loadPo('Cancel'); ?></a>
               </div>
         </form>
      </div>
      <!-- /.box -->
