...
<aside class="right-side">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $myobj->loadPo('Update Role'); ?></li>
        </ol>
    </section>
    <section class="content">       
        <div class="box">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo $myobj->loadPo('Update Role'); ?></h3>
                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="aa" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th><?php echo $myobj->loadPo('Permission'); ?><?php echo $myobj->loadPo('Main Tab Name'); ?></th>
                                                    <th><?php echo $myobj->loadPo('Permission'); ?><?php echo $myobj->loadPo('Sub Tab Name'); ?></th>
                                                    <th><label><input type="checkbox" name="all_view" id="all_view" value="" onclick="checkedAllCheckboxVerticale('all_view', 'view_')" >&nbsp;&nbsp; <?php echo $myobj->loadPo('View'); ?></label></th>
                                                    <th><label><input type="checkbox" name="all_add" id="all_add" value="" onclick="checkedAllCheckboxVerticale('all_add', 'add_')" >&nbsp;&nbsp; <?php echo $myobj->loadPo('Add'); ?></label></th>            
                                                    <th><label><input type="checkbox" name="all_edit" id="all_edit" value="" onclick="checkedAllCheckboxVerticale('all_edit', 'edit_')" >&nbsp;&nbsp; <?php echo $myobj->loadPo('Edit'); ?></label></th>
                                                    <th><label><input type="checkbox" name="all_delete" id="all_delete" value="" onclick="checkedAllCheckboxVerticale('all_delete', 'delete_')" >&nbsp;&nbsp; <?php echo $myobj->loadPo('Delete'); ?></label></th>  
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                    ...
                                                    if(!empty($tab_list)){
                                                        ...
                                                        ?>
                                                        <tr>        
                                                            <td colspan="4" ><?php echo $myobj->loadPo('No records found...'); ?></td>
                                                        </tr> 
                                                        <?php
                                                    }
                                                ?> 
