<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo base_url().MODULE_NAME;?>shipping"><?php echo $myobj->loadPo('About'); ?>Shipping</a></li>
         <li class="active"><?php echo $myobj->loadPo('Update Shipping'); ?></li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('Update Shipping'); ?> </h3>
            </div>
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="shipping_zone" id="shipping_zone" class="form-control" type="text" value="<?php echo $edit_shipping->shipping_zone; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="shipping_price" id="shipping_price" class="form-control" type="text" value="<?php echo $edit_shipping->shipping_price; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <select data-validation="required" name="shipping_zone_status" id="shipping_zone_status" class="form-control">
                           <option <?php echo ($edit_shipping->shipping_zone_status == 1) ? 'selected' : ''; ?> value="1">Active</option>
                           <option <?php echo ($edit_shipping->shipping_zone_status == 0) ? 'selected' : ''; ?> value="0">Inactive</option>
                        </select>
