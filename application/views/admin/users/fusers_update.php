<aside class="right-side">
   ...
   <section class="content-header">
      <h1><?php echo $myobj->loadPo('Users Update'); ?></h1>
      <ol class="breadcrumb">
         ...
         <li class="active"><?php echo $myobj->loadPo('Create Users Update'); ?> </li>
      </ol>
   </section>
   <!-- Main content -->
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input name="fuser_fname" id="fuser_fname" class="form-control" type="text" value="<?php echo $edit_users->fuser_fname; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input name="fuser_lname" id="fuser_lname" class="form-control" type="text" value="<?php echo $edit_users->fuser_lname; ?>"/>
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input name="fuser_email" id="fuser_email" class="form-control" type="text" value="<?php echo $edit_users->fuser_email; ?>" />
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input name="fuser_phone" id="fuser_phone" class="form-control" value="<?php echo $edit_users->fuser_phone; ?>" />
