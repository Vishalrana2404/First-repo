<aside class="right-side">
   ...
   <section class="content-header">
      <h1><?php echo $myobj->loadPo('Order Return Policy'); ?></h1>
      <ol class="breadcrumb">
         <li><a href="<?php echo base_url().MODULE_NAME;?>dashboard"><i class="fa fa-dashboard"></i> <?php echo $myobj->loadPo('Home'); ?></a></li>
         <li class="active"><?php echo $myobj->loadPo('Order Return Policy'); ?></li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('Order Return Policy'); ?> </h3>
            </div>
         </div>
         <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group col-md-12">
                     <div class="input text">
                        <label><?php echo $myobj->loadPo('Order Return Policy Description (English)'); ?><span class="text-danger">*</span></label>
               ...
               <div class="row">
                  <div class="form-group col-md-12">
                     <div class="input text">
                        <label><?php echo $myobj->loadPo('Order Return Policy Description (Arabic)'); ?><span class="text-danger">*</span></label>
