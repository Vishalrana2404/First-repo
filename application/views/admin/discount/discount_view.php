...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $myobj->loadPo('Discount'); ?></li>
        </ol>
    </section>   
    <!-- Main content -->
            ...
            <div class="box-header">
                <div class="pull-right box-tools">
                    <?php
                        ...
                        {
                            ?>
                                <a href="<?php echo base_url().MODULE_NAME;?>discount/addDiscount" class="btn btn-info btn-sm"><?php echo $myobj->loadPo('Add New'); ?></a>              
                            <?php
                        }
                    ?>                    
                </div>
                    ...
                    <table id="load_userlist" class="table table-bordered table-striped">
                        <thead>
                            <tr class="label-primary1">
                                ...
                                <th><?php echo $myobj->loadPo('Discount Name'); ?></th>                           
                                <th><?php echo $myobj->loadPo('Discount Type'); ?></th>                           
                                <th><?php echo $myobj->loadPo('Discount Amount'); ?></th>                           
                                <th><?php echo $myobj->loadPo('Discount Date'); ?></th>                           
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#load_userlist').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url(MODULE_NAME.'discount/loadDiscountListData')?>",
                "type": "POST",
                "dataType": "json",
