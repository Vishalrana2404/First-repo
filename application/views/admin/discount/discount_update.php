<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">U<?php echo $myobj->loadPo('Update Discount'); ?></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">       
        <div class="box box-success">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo $myobj->loadPo('Update Discount'); ?></h3>
                </div>
            ...
            <form action="" id="login_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="item form-group col-md-4">
                            <div class="input text">
                                ...
                                <input name="discount_name" required="required" class="form-control" type="text" id="discount_name" placeholder="Enter discount name" value="<?php echo $edit_discount->discount_name; ?>" />
                        ...
                        <div class="item form-group col-md-4">
                            <div class="input text">
                                ...
                                <input name="discount_amount" required="required" class="form-control" type="number" min="0" id="discount_amount" placeholder="Enter discount name" value="<?php echo $edit_discount->discount_amount; ?>" />
                        ...
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <div class='input-group'>
                                    <input autocomplete="off" data-validation="required" type="text" name="discount_start_date" id="discount_start_date" class="form-control current_date_val" value="<?php echo $edit_discount->discount_start_date; ?>" onchange="getEnddateValue(this.value)">
                        ...
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <div class='input-group' id="show_end_date">
                                    <input autocomplete="off" data-validation="required" type="text" name="discount_end_date" id="discount_end_date" class="form-control end_date_val" value="<?php echo $edit_discount->discount_end_date; ?>" >
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                ...
                <div class="box-footer">
                    <button class="btn btn-success btn-sm" type="submit" name="Submit" value="Edit" ><?php echo $myobj->loadPo('Save'); ?></button>
