<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $myobj->loadPo('Create Master Admin'); ?></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">       
        <div class="box box-success">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo $myobj->loadPo('Create Master Admin'); ?></h3>
                </div>
            ...
            <form action="" id="login_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <div class="input text">
                                <label><?php echo $myobj->loadPo('Username'); ?><span class="text-danger">*</span></label>
                        ...
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <div class='input-group'>
                                    <input type="text" class="form-control b_date_val" name="user_dob" id="user_dob" placeholder="" value="<?php echo set_value('user_dob'); ?>">
