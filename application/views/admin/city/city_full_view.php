<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><?php echo $myobj->loadPo('View City'); ?> </li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      ...
      <div class="box-header">
         <div class="pull-left">
            <h3 class="box-title"><?php echo $myobj->loadPo('View City'); ?>  </h3>
         </div>
            ...
            <div class="row">
               <div class="form-group col-md-4">
                  <div class="input text">
                     ...
                     <input disabled required data-validation="alphanumeric" data-validation-allowing="- _" name="city_name" id="city_name" class="form-control" type="text" value="<?php echo $edit_city->city_name; ?>" />
               ...
               <div class="form-group col-md-4">
                  <div class="input text">
                     ...
                     <select disabled data-validation="required" name="city_status" id="city_status" class="form-control">
            ...
            <div class="row">
               <div class="form-group col-md-4">
                   <div class="input text">
                       ...
                       <select disabled data-validation="required" name="country_id" id="country_id" class="form-control selectpicker" data-live-search="true" onchange="getStateListByCountryID(this.value)">
                           <?php
               ...
               <div class="form-group col-md-4">
                   <div class="input text">
                       ...
                       <select disabled data-validation="required" name="state_id" class="form-control selectpicker" id="state_id" data-live-search="true">
                           <?php
