<?php echo $myobj->loadPo('About'); ?><aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><?php echo $myobj->loadPo('Create City'); ?></li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      ...
      <div class="box-header">
         <div class="pull-left">
            <h3 class="box-title"><?php echo $myobj->loadPo('Create City'); ?> </h3>
         </div>
            ...
            <div class="row">
               <div class="form-group col-md-4">
                  <div class="input text">
                     ...
                     <input required data-validation="alphanumeric" data-validation-allowing="- _" name="city_name" id="city_name" class="form-control" type="text" value="<?php echo set_value('city_name'); ?>" />
