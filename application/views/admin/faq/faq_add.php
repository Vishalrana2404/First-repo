...
<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><?php echo $myobj->loadPo('Create FAQ'); ?></li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('Create FAQ'); ?> </h3>
            </div>
               ...
               <div class="row">
                  <div class="form-group col-md-6">
                     <div class="input text">
                        ...
                        <input required name="faq_title" id="faq_title" class="form-control" type="text" value="<?php echo set_value('faq_title'); ?>" />
                  ...
                  <div class="form-group col-md-6">
                     <div class="input text">
                        ...
                        <input required name="faq_title_ar" id="faq_title_ar" class="form-control" type="text" value="<?php echo set_value('faq_title_ar'); ?>" />
               ...
               <div class="row">
                  <div class="form-group col-md-12">
                     <div class="input text">
                        ...
                        <textarea name="faq_description" id="faq_description" class="form-control tiny_textarea"><?php echo set_value('faq_description'); ?></textarea>
               ...
               <div class="row">
                  <div class="form-group col-md-12">
                     <div class="input text">
                        ...
                        <textarea name="faq_description_ar" id="faq_description_ar" class="form-control tiny_textarea"><?php echo set_value('faq_description_ar'); ?></textarea>
