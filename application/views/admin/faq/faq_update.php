...
<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><?php echo $myobj->loadPo('FAQ'); ?> </li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('Update FAQ'); ?> </h3>
            </div>
            <div class="pull-right box-tools">
               <a href="<?php echo base_url().MODULE_NAME;?>faq" class="btn btn-info btn-sm"><?php echo $myobj->loadPo('About'); ?>Back</a>
            </div>
         </div>
            ...
            <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group col-md-6">
                     <div class="input text">
                        ...
                        <input required name="faq_title" id="faq_title" class="form-control" type="text" value="<?php echo $edit_faq->faq_title; ?>" />
                  ...
                  <div class="form-group col-md-6">
                     <div class="input text">
                        ...
                        <input required name="faq_title_ar" id="faq_title_ar" class="form-control" type="text" value="<?php echo $edit_faq->faq_title_ar; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <select data-validation="required" name="faq_status" id="faq_status" class="form-control">
                           ...
                           <option <?php echo ($edit_testimonial->faq_status == 0) ? 'selected' : ''; ?> value="0">Inactive</option>
                        </select>
               ...
               <div class="row">
                  <div class="form-group col-md-12">
                     <div class="input text">
                        <label><?php echo $myobj->loadPo('Description (English)'); ?><span class="text-danger">*</span></label>
                        <textarea name="faq_description" id="faq_description" class="form-control tiny_textarea"><?php echo $edit_faq->faq_description; ?></textarea>
               ...
               <div class="row">
                  <div class="form-group col-md-12">
                     <div class="input text">
                        <label><?php echo $myobj->loadPo('Description (Arabic)'); ?><span class="text-danger">*</span></label>
                        <textarea name="faq_description_ar" id="faq_description_ar" class="form-control tiny_textarea"><?php echo $edit_faq->faq_description_ar; ?></textarea>
                        <?php echo form_error('faq_description_ar','<span class="text-danger">','</span>'); ?>
                     </div>
                  </div>
               </div>
               <!-- /.box-body -->      
