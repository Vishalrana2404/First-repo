   ...
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('Privacy Policy'); ?> </h3>
            </div>
         </div>
         <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group col-md-12">
                     <div class="input text">
                        <label><?php echo $myobj->loadPo('Privacy Policy Description (English)'); ?><span class="text-danger">*</span></label>
               ...
               <div class="row">
                  <div class="form-group col-md-12">
                     <div class="input text">
                        <label><?php echo $myobj->loadPo('Privacy Policy Description (Arabic)'); ?><span class="text-danger">*</span></label>
               ...
               <div class="box-footer">
                  ...
                  <a class="btn btn-danger btn-sm" href="<?php echo base_url().MODULE_NAME;?>testimonial"><?php echo $myobj->loadPo('Cancel'); ?></a>
               </div>
         </form>
      </div>
      <!-- /.box -->
