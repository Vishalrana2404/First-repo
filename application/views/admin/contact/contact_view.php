                ...
                <table id="load_list" class="table table-bordered table-striped">
                    <thead>
                        <tr class="label-primary1">
                            ...
                            <th><?php echo $myobj->loadPo('Subject'); ?></th>                          
                            <th><?php echo $myobj->loadPo('Message'); ?></th>                          
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        table = $('#load_list').DataTable({ 
            ...
            "searching": true,
            "ajax": {
                "url": "<?php echo base_url(MODULE_NAME.'contact/loadData')?>",
                "type": "POST",
                "dataType": "json",
                "data":{},
                "data": function ( data ) {
