                  ...
                  if($tab_list->userView == '1' && $tab_list->status == '1')
                  {
                     if($tab_list->child_status == '0' && $tab_list->child_id == '0')
                     {
                        ...
                        <li class="<?php echo ($this->uri->segment(2)== $tab_list->controller_name)?'active':''?>">
                           <a href="<?php echo base_url().MODULE_NAME.$tab_list->controller_name; ?>">
                              ...
                              <span><?php echo ($lng == 'ara') ? $tab_list->tabname_ar : $tab_list->tabname; ?></span>
                           </a>
                        </li>
                        <?php
                     }
                     elseif($tab_list->child_status == '1' && $tab_list->child_id == '0')
                     {
                        ...
                        <li class="treeview <?php foreach($sub_memu_res as $t_value){
                           ...
                           <a href="<?php echo base_url().MODULE_NAME.$tab_list->controller_name; ?>">
                              <i class="<?php echo $tab_list->tab_icon; ?>"></i><span><?php echo ($lng == 'ara') ? $tab_list->tabname_ar : $tab_list->tabname; ?></span>
                              ...
                              <ul class="treeview-menu">
                                 ...
                                 foreach ($sub_memu_res as $sub_val)
                                 {
                                    if($sub_val->child_status == '2' && $sub_val->child_id == $tab_list->tab_id)
                                    {
                                       ...
                                       <li class="treeview">
                                          <a href="#">
                                             <i class="fa fa-share"></i> <span><?php echo ($lng == 'ara') ? $sub_val->tabname_ar : $sub_val->tabname; ?></span>
                                             <span class="pull-right-container">
                                                 <i class="fa fa-angle-left pull-right"></i>
                                             </span>
                                          </a>
                                          <ul class="treeview-menu">
                                             ...
                                             {
                                                 ?>
                                                 <li><a href="#"><i class="fa fa-circle-o"></i> <?php echo ($lng == 'ara') ? $sub_sub_val->tabname_ar : $sub_sub_val->tabname; ?></a></li>
                                                 <?php
                                             }
                                             ?>
                                          </ul>
                                    ...
                                    else
                                    {
                                       ...
                                       { 
                                          ...
                                          <li class="<?php echo ($this->uri->segment(2) == $sub_val->controller_name) ? 'active' : ''?>">
                                             <a href="<?php echo base_url().MODULE_NAME.$sub_val->controller_name; ?>"><i class="fa fa-tag"></i><span><?php echo ($lng == 'ara') ? $sub_val->tabname_ar : $sub_val->tabname; ?></span></a>
                                          </li>
                                          <?php
                                       }
                                    }
