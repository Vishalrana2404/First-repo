<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().MODULE_NAME;?>country"><?php echo $myobj->loadPo('About'); ?>ountry</a></li>
            <li class="active"><?php echo $myobj->loadPo('Update Country'); ?> </li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">       
        <div class="box box-success">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo $myobj->loadPo('Update Country'); ?></h3>
                </div>
                ...
                <div class="box-body"><br>
                    ...
                    <div class="form-group col-md-5">
                            <div class="input text">
                                ...
                                <input required data-validation="alphanumeric" data-validation-allowing="- _" name="country_name" id="country_name" class="form-control" type="text" value="<?php echo $edit_country->country_name; ?>" />
                          ...
                          <div class="form-group col-md-5">
                            <div class="input text">
                                ...
                                <select data-validation="required" name="country_status" id="country_status" class="form-control">
                                    <option <?php if($edit_country->country_status   == '1'){ echo "selected"; } ?> value="1">Active</option>
                                    <option <?php if($edit_country->country_status   == '0'){ echo "selected"; } ?> value="0">Inactive</option>
                                </select>
