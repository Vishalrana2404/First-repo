<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $myobj->loadPo('Country'); ?></li>
        </ol>
    </section>   
    <!-- Main content -->
            ...
            <div class="box-header">
                <div class="pull-right box-tools">
                    <?php
                        ...
                        {
                            ?>
                                <a href="<?php echo base_url().MODULE_NAME;?>country/addCountry" class="btn btn-info btn-sm"><?php echo $myobj->loadPo('Add New'); ?></a>              
                            <?php  
                        }
                    ?>                    
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        table = $('#load_list').DataTable({ 
            ...
            "searching": true,
            "ajax": {
                "url": "<?php echo base_url(MODULE_NAME.'country/loadData')?>",
                "type": "POST",
                "dataType": "json",
                "data":{},
                "data": function ( data ) {
