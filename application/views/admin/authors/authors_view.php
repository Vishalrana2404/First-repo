<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $myobj->loadPo('Authors'); ?></li>
        </ol>
    </section>   
    <!-- Main content -->
            ...
            <div class="box-header">
                <div class="pull-right box-tools">
                    <?php
                        ...
                        {
                            ?>
                                <a href="<?php echo base_url().MODULE_NAME;?>authors/addAuthors" class="btn btn-info btn-sm"><?php echo $myobj->loadPo('Add New'); ?></a>              
                            <?php  
                        }
                    ?>                    
                </div>
                ...
                <table id="load_list" class="table table-bordered table-striped">
                    <thead>
                        <tr class="label-primary1">
                            ...
                            <th><?php echo $myobj->loadPo('Logo'); ?></th>        
                            <th><?php echo $myobj->loadPo('Name (English)'); ?></th>                          
                            <th><?php echo $myobj->loadPo('Name (Arabic)'); ?></th>                          
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        table = $('#load_list').DataTable({ 
            ...
            "searching": true,
            "ajax": {
                "url": "<?php echo base_url(MODULE_NAME.'authors/loadData')?>",
                "type": "POST",
                "dataType": "json",
                "data":{},
                "data": function ( data ) {
