<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><?php echo $myobj->loadPo('Create Author'); ?> </li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('Create Author'); ?></h3>
            </div>
         ...
         <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="authors_name" id="authors_name" class="form-control" type="text" value="<?php echo set_value('authors_name'); ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="authors_name_ar" id="authors_name_ar" class="form-control" type="text" value="<?php echo set_value('authors_name_ar'); ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input name="authors_email" id="authors_email" class="form-control" type="email" value="<?php echo set_value('authors_email'); ?>" />
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input name="authors_phone_no" id="authors_phone_no" class="form-control" type="text" value="<?php echo set_value('authors_phone_no'); ?>" />
                     </div>
                  </div>
                  <div class="form-group col-md-4">
                     <div class="input text">
                        <label><?php echo $myobj->loadPo('Status'); ?><span class="text-danger">*</span></label>
                        <select data-validation="required" name="authors_status" id="authors_status" class="form-control">
               ...
               <div class="row">
                   <div class="form-group col-md-4">
                      <div class="input text">
                          <label><?php echo $myobj->loadPo('Author Image'); ?></label>
                          <input data-validation="mime size" data-validation-allowing="jpg, png, gif, jpeg, jpe" data-validation-max-size="3M" name="authors_img" type="file" id="authors_img" value="" />
               ...
               <div class="box-footer">
                  ...
                  <a class="btn btn-danger btn-sm" href="<?php echo base_url().MODULE_NAME;?>authors"><?php echo $myobj->loadPo('Cancel'); ?></a>
               </div>
         </form>
      </div>
      <!-- /.box -->
