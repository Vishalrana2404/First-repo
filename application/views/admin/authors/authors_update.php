<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo base_url().MODULE_NAME;?>authorss"><?php echo $myobj->loadPo('Authors'); ?></a></li>
         <li class="active"><?php echo $myobj->loadPo('Update Author'); ?></li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('Update Author'); ?> </h3>
            </div>
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="authors_name" id="authors_name" class="form-control" type="text" value="<?php echo $edit_authors->authors_name; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input required name="authors_name_ar" id="authors_name_ar" class="form-control" type="text" value="<?php echo $edit_authors->authors_name_ar; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input name="authors_email" id="authors_email" class="form-control" type="email" value="<?php echo $edit_authors->authors_email; ?>" />
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input name="authors_phone_no" id="authors_phone_no" class="form-control" type="text" value="<?php echo $edit_authors->authors_phone_no; ?>" />
