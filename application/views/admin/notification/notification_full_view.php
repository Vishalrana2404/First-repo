<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><?php echo $myobj->loadPo('View Notification'); ?></li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      <div class="box box-success">
         <div class="box-header">
            <div class="pull-left">
               <h3 class="box-title"><?php echo $myobj->loadPo('View Notification'); ?></h3>
            </div>
               ...
               <div class="row">
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <input disabled required name="notification_title" id="notification_title" class="form-control" type="text" value="<?= $edit_notification->notification_title; ?>" />
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <select disabled data-validation="required" name="notification_status" id="notification_status" class="form-control">
                  ...
                  <div class="form-group col-md-4">
                     <div class="input text">
                        ...
                        <select disabled data-validation="required" name="notification_to" id="notification_to" class="form-control">
                  ...
                  <div class="form-group col-md-12">
                     <div class="input text">
                        <label><?php echo $myobj->loadPo('Notification Description'); ?><span class="text-danger">*</span></label><br>
                        <span class="textarea_view"><?php echo $edit_notification->notification_description?></span>
