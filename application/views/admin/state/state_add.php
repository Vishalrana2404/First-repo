<aside class="right-side">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active"><?php echo $myobj->loadPo('Create State'); ?></li>
      </ol>
   </section>
   <!-- Main content -->
   <section class="content">
      ...
      <div class="box-header">
         <div class="pull-left">
            <h3 class="box-title"><?php echo $myobj->loadPo('Create State'); ?> </h3>
         </div>
            ...
            <div class="row">
               <div class="form-group col-md-4">
                  <div class="input text">
                     ...
                     <input required data-validation="alphanumeric" data-validation-allowing="- _" name="state_name" id="state_name" class="form-control" type="text" value="<?php echo set_value('state_name'); ?>" />
                     ...
                     <select data-validation="required" name="country_id" id="country_id" class="form-control">
                        ...
                        <?php
                           ...
                           if(!empty($country_res))
                           {
                              ...
                              {
                                 ?>
                                 <option value="<?php echo $s_val->country_id; ?>"><?php echo $s_val->country_name; ?></option>
                                 <?php
                              }
                           }
                        ?>
               ...
               <div class="form-group col-md-4">
                  <div class="input text">
                     ...
                     <select data-validation="required" name="state_status" id="state_status" class="form-control">
                        <option value="1">Active</option>
                        <option value="0">Inactive</option>
                     </select>
                     <?php echo form_error('state_status','<span class="text-danger">','</span>'); ?>
                  </div>
               </div>
            </div>
            <!-- /.box-body -->      
