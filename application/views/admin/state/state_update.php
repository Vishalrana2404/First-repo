<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $myobj->loadPo('Update State'); ?> </li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">       
        <div class="box box-success">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo $myobj->loadPo('Update State'); ?> </h3>
                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <input required data-validation="alphanumeric" data-validation-allowing="- _" name="state_name" id="state_name" class="form-control" type="text" value="<?php echo $edit_state->state_name; ?>" />
                        ...
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <select data-validation="required" name="country_id" id="country_id" class="form-control selectpicker" data-live-search="true">
                                    <?php
