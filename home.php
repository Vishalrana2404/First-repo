                        ...
                        <a href="<?php echo base_url().'book_detail/'.$fetb_val->book_id; ?>">
                           ...
                           <div class="content">
                             ...
                             <div class="qer">
                              ...
                              <div class="ratStar">
                                 <b class="qar">QAR <?php echo $fetb_val->book_price; ?></b> 
                              </div>
                             </div>
                              <p class="mb-0">
                                 <?php 
...
<div id="" class="section wb pbottom" data-stellar-background-ratio="0.7" style="background-image:url('<?php echo base_url(); ?>webroot/front/images/backimg.png');">
   <div class="container">
      <div class="bokhead">
         <div class="sectionHead">
...
<div class="carousel-showmanymoveone owl-carousel  owl-rtl owl-loaded owl-drag">
   <div class="container">  
      ...
      <div class="owl-stage-outer">
         <div class="owl-stage">
            <?php
               $authors_res = $this->common_model->getData('tbl_authors', array('authors_status'=>'1'), 'multi', NULL, 'rand()', '15');
